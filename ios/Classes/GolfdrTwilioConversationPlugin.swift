...
public class GolfdrTwilioConversationPlugin: NSObject, FlutterPlugin, FlutterStreamHandler {
  ...
  //  }
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterMethodChannel(name: "golfdr_twilio_conversation", binaryMessenger: registrar.messenger())
    let synchronizationStatusEventChannel = FlutterEventChannel(name: "golfdr_twilio_conversation/synchronizationStatusEventChannel", binaryMessenger: registrar.messenger())
    let onClientSynchronizationChangedEventChannel = FlutterEventChannel(name: "golfdr_twilio_conversation/onClientSynchronizationChanged", binaryMessenger: registrar.messenger())
    let messageEventChannel = FlutterEventChannel(name: "golfdr_twilio_conversation/onMessageUpdated", binaryMessenger: registrar.messenger())
    let tokenEventChannel = FlutterEventChannel(name: "golfdr_twilio_conversation/onTokenStatusChange", binaryMessenger: registrar.messenger())
