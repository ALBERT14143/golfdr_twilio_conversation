...
import 'golfdr_twilio_conversation_platform_interface.dart';

class GolfdrTwilioConversation {
  Future<String?> getPlatformVersion() {
    return GolfdrTwilioConversationPlatform.instance.getPlatformVersion();
  }
// Event channels for message updates and token status changes.
  static const EventChannel _messageEventChannel =
      EventChannel('golfdr_twilio_conversation/onMessageUpdated');
  static const EventChannel _tokenEventChannel =
      EventChannel('golfdr_twilio_conversation/onTokenStatusChange');
  static const EventChannel _clientEventChannel =
      EventChannel('golfdr_twilio_conversation/onClientSynchronizationChanged');
  ...
  Future<String?> generateToken(
      ...
      required serviceSid,
      required pushSid}) {
    return GolfdrTwilioConversationPlatform.instance.generateToken(
  ...
  Future<String?> initializeConversationClient(
    ...
    var result = await GolfdrTwilioConversationPlatform.instance
  ...
  Future<String?> registerFCMToken({required String fcmToken}) {
    return GolfdrTwilioConversationPlatform.instance
  ...
  Future<String?> createConversation(
    ...
    return GolfdrTwilioConversationPlatform.instance.createConversation(
  ...
  Future<List?> getConversations() {
    return GolfdrTwilioConversationPlatform.instance.getConversations();
  }
  ...
  Future<List?> getMessages(
    ...
    return GolfdrTwilioConversationPlatform.instance.getMessages(
  ...
  Future<String?> sendMessage(
    ...
    return GolfdrTwilioConversationPlatform.instance.sendMessage(
  ...
  Future<String?> sendMessageWithMedia(
      ...
      required mimeType,
      required fileName}) {
    return GolfdrTwilioConversationPlatform.instance.sendMessageWithMedia(
        message: message,
  ...
  Future<String?> addParticipant(
    ...
    return GolfdrTwilioConversationPlatform.instance.addParticipant(
  ...
  Future<String?> removeParticipant(
      {required participantName, required conversationId}) {
    return GolfdrTwilioConversationPlatform.instance.removeParticipant(
        conversationId: conversationId, participantName: participantName);
  }
  ...
  void subscribeToMessageUpdate({required String conversationSid}) async {
    GolfdrTwilioConversationPlatform.instance
