...
/// An implementation of [GolfdrTwilioConversationPlatform] that uses method channels.
class MethodChannelGolfdrTwilioConversation extends GolfdrTwilioConversationPlatform {
  /// The method channel used to interact with the native platform.
  @visibleForTesting
  final methodChannel = const MethodChannel('golfdr_twilio_conversation');
