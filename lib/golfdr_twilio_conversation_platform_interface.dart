...
import 'golfdr_twilio_conversation_method_channel.dart';

abstract class GolfdrTwilioConversationPlatform extends PlatformInterface {
  /// Constructs a GolfdrTwilioConversationPlatform.
  GolfdrTwilioConversationPlatform() : super(token: _token);

  static final Object _token = Object();

  static GolfdrTwilioConversationPlatform _instance = MethodChannelGolfdrTwilioConversation();

  /// The default instance of [GolfdrTwilioConversationPlatform] to use.
  ///
  /// Defaults to [MethodChannelGolfdrTwilioConversation].
  static GolfdrTwilioConversationPlatform get instance => _instance;

  /// Platform-specific implementations should set this with their own
  /// platform-specific class that extends [GolfdrTwilioConversationPlatform] when
  /// they register themselves.
  static set instance(GolfdrTwilioConversationPlatform instance) {
